package com.example.realtimelanguagechange.Helper;
...
public class LocalHelper {
    ...
    public static Context onAttach(Context context){
        String lang = getPersistantData(context, Locale.getDefault().getLanguage());
    ...
    private static String getPersistantData(Context context, String language){
